module.exports = function (query, queryString) {
    ...
    this.filtering = () => {
        ...
        if (queryObj.detailSize) {
            if (queryObj.detailSize.elemMatch != "") {
                queryObj.detail = {
                    elemMatch: { size: queryObj.detailSize.elemMatch },
                };
            } else {
                delete queryObj.detailSize;
            }
        }
        if (queryObj.detailColor) {
            if (queryObj.detailColor.elemMatch != "") {
                queryObj.detail = {
                    elemMatch: { color: queryObj.detailColor.elemMatch },
                };
            } else {
                delete queryObj.detailColor;
            }
        }
        // let queryStr;
        // if (queryObj.price) {
